...
const Projects = () => (
  <Main meta={<Meta title="Projects" description="Projects" />}>
    <Content>
      ...
      <h2>
        <span>
          <a href="https://quote-generator-next.vercel.app" target="_blank">Quote Generator (→)</a>
          • 2021
          • Social Image Generator
          • <a href="https://github.com/dsab123/quote-generator-next" target="_blank">
            <img src="/assets/images/octocat.png" style={{ height: '20px', display: 'inline-block' }}></img> (→)
          </a>
        </span>
      </h2>
      ...
      <h2>
        <span>
          <a href="http://danielsabbagh.com" target="_blank">danielsabbagh.com (→)</a>
          • 2020
          • Hand-Spun Reading Blog
          • <a href="https://github.com/dsab123/website-nextjs" target="_blank">
            <img src="/assets/images/octocat.png" style={{ height: '20px', display: 'inline-block' }}></img> (→)
          </a>
        </span>
      </h2>
      ...
      <h2>
        <span>
          <a href="http://playhymns.herokuapp.com" target="_blank">PlayHymns! (→)</a>
          • 2020
          • First Ever Web App
          • <a href="https://github.com/dsab123/playhymn3" target="_blank">
            <img src="/assets/images/octocat.png" style={{ height: '20px', display: 'inline-block' }}></img> (→)
          </a>
        </span>
      </h2>
